...
import com.page.jwt.JwtRequestFilter;
import com.page.jwt.JwtTokenProvider;
import com.page.service.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
         ...
         .authorizeHttpRequests(authorizeRequests ->
             authorizeRequests
                 ...
                 .requestMatchers("/land/page").authenticated()
         )
